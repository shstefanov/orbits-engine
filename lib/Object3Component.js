...
class Object3Component extends Component {
	...
	UNSAFE_componentWillMount(){
		this.props.debug && console.log("ReactWillMount: ", this.constructor.name, this.props);
		this.loadElement(
			this.props.geometry,
			this.props.material,
		).then( () => {
			this.await_element = false;
			this.props.debug && console.log("OrbitsWillMountElement: ", this.constructor.name, this.props);
			this.mountElement();
			if(this.element){
			...
			this.props.debug && console.log("OrbitsWillMountInteraction: ", this.constructor.name, this.props);
	...
	async loadElement(geometry, material){
		this.await_element = true;
		this.props.debug && console.log("OrbitsLoadingElement: ", this.constructor.name, this.props);
			...
			for(let material_data of material){
				...
				if(typeof material_data === "string" || material_data.src) {
					...
					if(textures){
						...
						// this.setState({ ___texture_loaded: Date.now() })
					}
		...
		this.props.debug && console.log("OrbitsElementLoaded: ", this.constructor.name, this.props);
	}
	...
	render(){
		if(this.await_element) {
			this.props.debug && console.log("ReactRenderAwaitElement: ", this.constructor.name, this.props);
			return null;
		}
		if(this.element){
			this.props.debug && console.log("ReactRenderWithElement: ", this.constructor.name, this.props);
			// Creating new context should allow us to nest the objects in the scene
			this.render_context = this.render_context || { ...this.context, scene: this.element };
			return React.createElement(
				OrbitsSceneProvider,
				{ value: this.render_context },
			...
			this.props.debug && console.log("ReactRenderWithoutElement: ", this.constructor.name, this.props);
			...
			this.props.debug && console.log("ReactRenderNull: ", this.constructor.name, this.props);
			return null;
		}
	}
	...
	mountElement(){
		...
		this.props.debug && console.log("OrbitsMounting: ", this.constructor.name, this.props);

		this.element = this.createElement();
		const el = this.element;


		// this.props.debug && this.props.debug && console.log("MountElement:", this.constructor.name, this.props.id, {
		...
		scene.add(el);
		this.props.debug && console.log("OrbitsMounted: ", this.constructor.name, this.props);
	}
	// Unmount element
	unmountElement(){
		if(this.element) this.element.parent.remove(this.element);
		this.props.debug && console.log("Unmount:", this.constructor.name, this.props.id, {
			hasInteractions: this.hasInteractions(this.props),
			element: this.element,
			props: { ...this.props },
		});
